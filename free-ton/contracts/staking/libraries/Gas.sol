...
library Gas {
    ...
    uint128 constant PLATFORM_DEPLOY_VALUE = 0.5 ton;
    uint128 constant DEPLOY_ELECTION_MIN_VALUE = 1 ton;
    uint128 constant DEPLOY_RELAY_ROUND_MIN_VALUE = 1 ton;
    ...
    uint128 constant RELAY_ROUND_INITIAL_BALANCE = 0.5 ton;
    ...
    uint128 constant MIN_GET_REWARD_RELAY_ROUND_MSG_VALUE = 0.5 ton;
