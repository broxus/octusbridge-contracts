...
contract ConvexBUSDStrategy is ConvexCrvLp, Initializable {
    ...
    address public constant busd3crv = address(0x4807862AA8b2bF68830e4C8dc86D0e9A998e085a);
    ...
    function initialize(
        ...
        profitFactor = 100000;
        debtThreshold = 1e24;
        want_wrapped = IERC20Upgradeable(busd3crv);
