...
import "./../storage/VaultStorageInitializable.sol";


abstract contract VaultHelperInitializable {
    /**
    ...
    modifier initializer() {
        VaultStorageInitializable.InitializableStorage storage s = VaultStorageInitializable._storage();
