...
describe("Test Alien proxy upgrade", async function () {
  ...
  it("Check api version", async () => {
    const api_version = await proxy_v1.methods
      .apiVersion({ answerId: 0 })
      .call({ responsible: true })
      .then(t => t.value0);

    expect(api_version).to.be.equal("1", "Wrong api version");
  });

  describe("Upgrade proxy to V2", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v1.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      _owner = await proxy_v1.methods
        .owner()
        .call()
        .then(t => t.owner);
    });
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V2 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V2");
      ...
      proxy_v2 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V2", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v2.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("2", "Wrong api version");
    });

    it("Check state", async () => {
      const configuration = await proxy_v2.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(configuration.everscaleConfiguration.toString()).to.be.eql(
    ...
    it("Check owner", async () => {
      const { owner } = await proxy_v2.methods.owner().call();
  ...
  describe("Update proxy to V3", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v2.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      _owner = await proxy_v2.methods
        .owner()
        .call()
        .then(t => t.owner);
    });
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V3 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V3");
      ...
      proxy_v3 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V3", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v3.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("3", "Wrong api version");
    });

    it("Check state", async () => {});

    it("Check owner", async () => {
      const { owner } = await proxy_v3.methods.owner().call();
  ...
  describe("Update proxy to V4", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v3.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      _owner = await proxy_v3.methods
        .owner()
        .call()
        .then(t => t.owner);
    });
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V4 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V4");
      ...
      proxy_v4 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V4", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v4.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("4", "Wrong api version");
    });

    it("Check state", async () => {});

    it("Check owner", async () => {
      const { owner } = await proxy_v4.methods.owner().call();
  ...
  describe("Update proxy to V5", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v4.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      _owner = await proxy_v4.methods
        .owner()
        .call()
        .then(t => t.owner);
    });
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V5 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V5");
      ...
      proxy_v5 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V5", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v5.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("5", "Wrong api version");
    });
  ...
  describe("Update proxy to V6", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v5.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      _owner = await proxy_v5.methods
        .owner()
        .call()
        .then(t => t.owner);
    });
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V6 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V6");
      ...
      proxy_v6 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V6", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v6.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("6", "Wrong api version");
    });
  ...
  describe("Update proxy to V7", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v6.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      _owner = await proxy_v6.methods
        .owner()
        .call()
        .then(t => t.owner);
    });
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V7 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V7");
      ...
      proxy_v7 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V7", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v7.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("7", "Wrong api version");
    });
    ...
    it("Check owner", async () => {
      const { owner } = await proxy_v7.methods.owner().call();
  ...
  describe("Update proxy to V8", async () => {
    ...
    it("Upgrade", async () => {
      const ProxyMultiVaultAlien_V8 = locklift.factory.getContractArtifacts("ProxyMultiVaultAlien_V8");
      ...
      proxy_v8 = locklift.factory.getDeployedContract("ProxyMultiVaultAlien_V8", proxy_v1.address);
    });

    it("Check API version", async () => {
      const api_version = await proxy_v8.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("8", "Wrong api version");
    });
    ...
    it("Check owner", async () => {
      const { owner } = await proxy_v8.methods.owner().call();

      expect(owner.toString()).to.be.equal(_owner.toString(), "Wrong owner after upgrade");
    });
  });

  describe("Update proxy to V9", async () => {
    it("Save state", async () => {
      _configuration = await proxy_v7.methods
        .getConfiguration({ answerId: 0 })
        .call({ responsible: true })
    ...
    it("Check API version", async () => {
      const api_version = await proxy_v9.methods
        .apiVersion({ answerId: 0 })
        .call({ responsible: true })
        .then(t => t.value0);

      expect(api_version).to.be.equal("9", "Wrong api version");
    });
