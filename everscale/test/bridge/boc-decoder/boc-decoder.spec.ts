...
const TRANSACTION_PROONED = "";
...
describe("BocDecoder", () => {
  ...
  it("Decode prooned transaction", async () => {
    ...
    expect(result).to.deep.equal({
      accountAddr: "55014073148734881924620049420919669079220098959678101003487217555686036751953",
      lt: "1529268000010",
      nowTimestamp: "1742565504",
      outMessages: [["0", ""]],
    });
  });
