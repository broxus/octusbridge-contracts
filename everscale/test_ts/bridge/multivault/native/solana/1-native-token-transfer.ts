...
describe('Test Solana native multivault pipeline', async function() {
    ...
    describe('Transfer native token from Everscale to Solana', async () => {
        ...
        let eventContract: Contract<FactorySource["MultiVaultEverscaleSolanaEventNative"]>;

        it('Transfer tokens to the Native Proxy', async () => {
            const payload = await cellEncoder.methods.encodeNativeTransferPayloadSolana({
                recipient,
            ...
            eventContract = await locklift.factory.getDeployedContract('MultiVaultEverscaleSolanaEventNative', expectedEventContract);
    ...
    describe('Transfer native token from Solana to Everscale', async () => {
        ...
        let eventContract: Contract<FactorySource["MultiVaultSolanaEverscaleEventNative"]>;
        ...
        it('Initialize event', async () => {
            ...
            eventDataEncoded = await cellEncoder.methods.encodeMultiVaultNativeSolanaEverscale(eventDataStructure).call();
            ...
            eventContract = await locklift.factory.getDeployedContract('MultiVaultSolanaEverscaleEventNative', expectedEventContract.eventContract);
        ...
        it('Check event state before confirmation', async () => {
            ...
            expect(details._eventInitData.voteData.accountSeed)
                .to.be.equal(eventVoteData.accountSeed, 'Wrong account seed');
