...
import "ton-eth-bridge-token-contracts/contracts/libraries/TokenMsgFlag.sol";


contract AlienTokenWalletPlatform {
    address static root;
    ...
    function _getExpectedAddress(address owner_) private view returns (address) {
        TvmCell stateInit = tvm.buildStateInit({
            contr: AlienTokenWalletPlatform,
            varInit: {
                root: root,
                owner: owner_
            },
